...
- Ability to observe check outcomes and receive notifications according to outcomes:
...
- Dashboard to visualize status of any health checks defined by the user
    ...
    - Graphical UI for access and summary of performance statistics to assess correctness of the execution of the check itself
